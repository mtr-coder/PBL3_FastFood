...
namespace PBL3
{
    partial class QuanLiNhaCungCap
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            _btnXemLichSu = new RoundedPanel();
            lblBtnXemLichSu = new Label();
            _btnTaoDonNhap = new RoundedPanel();
            lblBtnTaoDonNhap = new Label();
            pnlTimKiem = new RoundedPanel();
            _txtTimKiem = new TextBox();
            pnlDiaChiInput = new RoundedPanel();
            _txtDiaChi = new TextBox();
            lblDiaChi = new Label();
            pnlMatHangInput = new RoundedPanel();
            _txtMatHang = new TextBox();
            lblMatHang = new Label();
            pnlHoTenInput = new RoundedPanel();
            _txtHoTen = new TextBox();
            lblHoTen = new Label();
            pnlMaNCCInput = new RoundedPanel();
            _txtMaNCC = new TextBox();
            lblMaNV = new Label();
            pnlDanhSachNhanVien = new RoundedPanel();
            _dgvNhanVien = new DataGridView();
            lb_DSNhaCungCap = new Label();
            ...
            _btnXemLichSu.SuspendLayout();
            _btnTaoDonNhap.SuspendLayout();
            pnlTimKiem.SuspendLayout();
            pnlDiaChiInput.SuspendLayout();
            pnlMatHangInput.SuspendLayout();
            pnlHoTenInput.SuspendLayout();
            pnlMaNCCInput.SuspendLayout();
            ...
            lb_QLNhanVienTitle.Location = new Point(339, 8);
            lb_QLNhanVienTitle.Name = "lb_QLNhanVienTitle";
            lb_QLNhanVienTitle.Size = new Size(266, 35);
            lb_QLNhanVienTitle.TabIndex = 4;
            lb_QLNhanVienTitle.Text = "Quản lý nhà cung cấp";
            // 
            // pnlFormNhanVien
            // 
            ...
            pnlFormNhanVien.Size = new Size(834, 251);
            ...
            pnlSdtInput.Location = new Point(422, 44);
            ...
            // pnlEmailInput
            // 
            pnlEmailInput.BackColor = Color.Bisque;
            pnlEmailInput.Controls.Add(_txtEmail);
            pnlEmailInput.CornerRadius = 8;
            pnlEmailInput.Location = new Point(587, 44);
            pnlEmailInput.Name = "pnlEmailInput";
            pnlEmailInput.Size = new Size(240, 33);
            pnlEmailInput.TabIndex = 27;
            // 
            // _txtEmail
            // 
            _txtEmail.BackColor = Color.Bisque;
            _txtEmail.BorderStyle = BorderStyle.None;
            _txtEmail.Location = new Point(10, 5);
            _txtEmail.Name = "_txtEmail";
            _txtEmail.Size = new Size(218, 20);
            _txtEmail.TabIndex = 8;
            // 
            // _btnSua
            // 
            ...
            lblSdt.Location = new Point(398, 16);
            lblSdt.Name = "lblSdt";
            ...
            lblEmail.Location = new Point(560, 16);
            ...
            // _btnXemLichSu
            // 
            _btnXemLichSu.BackColor = Color.Peru;
            _btnXemLichSu.Controls.Add(lblBtnXemLichSu);
            _btnXemLichSu.CornerRadius = 10;
            _btnXemLichSu.Location = new Point(551, 123);
            _btnXemLichSu.Name = "_btnXemLichSu";
            _btnXemLichSu.Size = new Size(146, 32);
            _btnXemLichSu.TabIndex = 21;
            _btnXemLichSu.Click += BtnXemLichSu_Click;
            // 
            // lblBtnXemLichSu
            // 
            lblBtnXemLichSu.AutoSize = true;
            lblBtnXemLichSu.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
            lblBtnXemLichSu.ForeColor = Color.White;
            lblBtnXemLichSu.Location = new Point(4, 5);
            lblBtnXemLichSu.Name = "lblBtnXemLichSu";
            lblBtnXemLichSu.Size = new Size(138, 20);
            lblBtnXemLichSu.TabIndex = 0;
            lblBtnXemLichSu.Text = "Xem nhanh lịch sử";
            lblBtnXemLichSu.Click += BtnXemLichSu_Click;
            // 
            // _btnTaoDonNhap
            // 
            _btnTaoDonNhap.BackColor = Color.Peru;
            _btnTaoDonNhap.Controls.Add(lblBtnTaoDonNhap);
            _btnTaoDonNhap.CornerRadius = 10;
            _btnTaoDonNhap.Location = new Point(712, 123);
            _btnTaoDonNhap.Name = "_btnTaoDonNhap";
            _btnTaoDonNhap.Size = new Size(119, 32);
            _btnTaoDonNhap.TabIndex = 22;
            _btnTaoDonNhap.Click += BtnTaoDonNhap_Click;
            // 
            // lblBtnTaoDonNhap
            // 
            lblBtnTaoDonNhap.AutoSize = true;
            lblBtnTaoDonNhap.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
            lblBtnTaoDonNhap.ForeColor = Color.White;
            lblBtnTaoDonNhap.Location = new Point(6, 5);
            lblBtnTaoDonNhap.Name = "lblBtnTaoDonNhap";
            lblBtnTaoDonNhap.Size = new Size(105, 20);
            lblBtnTaoDonNhap.TabIndex = 0;
            lblBtnTaoDonNhap.Text = "Tạo đơn nhập";
            lblBtnTaoDonNhap.Click += BtnTaoDonNhap_Click;
            // 
            // pnlTimKiem
            // 
            ...
            pnlDiaChiInput.Location = new Point(291, 123);
            ...
            lblDiaChi.Location = new Point(259, 97);
            ...
            // pnlMatHangInput
            // 
            pnlMatHangInput.BackColor = Color.Bisque;
            pnlMatHangInput.Controls.Add(_txtMatHang);
            pnlMatHangInput.CornerRadius = 8;
            pnlMatHangInput.Location = new Point(33, 125);
            pnlMatHangInput.Name = "pnlMatHangInput";
            pnlMatHangInput.Size = new Size(201, 33);
            pnlMatHangInput.TabIndex = 30;
            // 
            // _txtMatHang
            // 
            _txtMatHang.BackColor = Color.Bisque;
            _txtMatHang.BorderStyle = BorderStyle.None;
            _txtMatHang.Location = new Point(11, 5);
            _txtMatHang.Name = "_txtMatHang";
            _txtMatHang.Size = new Size(181, 20);
            _txtMatHang.TabIndex = 31;
            // 
            // lblMatHang
            // 
            lblMatHang.AutoSize = true;
            lblMatHang.Font = new Font("Segoe UI", 10F, FontStyle.Bold);
            lblMatHang.Location = new Point(18, 97);
            lblMatHang.Name = "lblMatHang";
            lblMatHang.Size = new Size(70, 23);
            lblMatHang.TabIndex = 28;
            lblMatHang.Text = "Ghi chú";
            // 
            // pnlHoTenInput
            // 
            ...
            pnlHoTenInput.Location = new Point(203, 44);
            ...
            lblHoTen.Location = new Point(187, 16);
            ...
            // pnlMaNCCInput
            // 
            pnlMaNCCInput.BackColor = Color.Gainsboro;
            pnlMaNCCInput.Controls.Add(_txtMaNCC);
            pnlMaNCCInput.CornerRadius = 8;
            pnlMaNCCInput.Location = new Point(33, 44);
            pnlMaNCCInput.Name = "pnlMaNCCInput";
            pnlMaNCCInput.Size = new Size(125, 33);
            pnlMaNCCInput.TabIndex = 23;
            // 
            // _txtMaNCC
            // 
            _txtMaNCC.BackColor = Color.Gainsboro;
            _txtMaNCC.BorderStyle = BorderStyle.None;
            _txtMaNCC.Enabled = false;
            _txtMaNCC.Location = new Point(10, 5);
            _txtMaNCC.Name = "_txtMaNCC";
            _txtMaNCC.ReadOnly = true;
            _txtMaNCC.Size = new Size(102, 20);
            _txtMaNCC.TabIndex = 1;
            _txtMaNCC.TabStop = false;
            // 
            // lblMaNV
            // 
            ...
            pnlDanhSachNhanVien.Controls.Add(lb_DSNhaCungCap);
            ...
            // lb_DSNhaCungCap
            // 
            lb_DSNhaCungCap.AutoSize = true;
            lb_DSNhaCungCap.Font = new Font("Segoe UI", 11F, FontStyle.Bold);
            lb_DSNhaCungCap.ForeColor = Color.FromArgb(110, 92, 75);
            lb_DSNhaCungCap.Location = new Point(18, 12);
            lb_DSNhaCungCap.Name = "lb_DSNhaCungCap";
            lb_DSNhaCungCap.Size = new Size(226, 25);
            lb_DSNhaCungCap.TabIndex = 0;
            lb_DSNhaCungCap.Text = "Danh sách nhà cung cấp";
            // 
            // hcnt_KhungMenuAD
            // 
            ...
            label8.TabIndex = 0;
            label8.Text = "Quản lí nguyện liệu";
            ...
            Name = "QuanLiNhaCungCap";
            StartPosition = FormStartPosition.CenterScreen;
            Text = "QuanLiNhaCungCap";
            Load += QuanLiNhaCungCap_Load;
            ...
            _btnXemLichSu.ResumeLayout(false);
            _btnXemLichSu.PerformLayout();
            _btnTaoDonNhap.ResumeLayout(false);
            _btnTaoDonNhap.PerformLayout();
            pnlTimKiem.ResumeLayout(false);
            pnlTimKiem.PerformLayout();
            pnlDiaChiInput.ResumeLayout(false);
            pnlDiaChiInput.PerformLayout();
            pnlMatHangInput.ResumeLayout(false);
            pnlMatHangInput.PerformLayout();
            pnlHoTenInput.ResumeLayout(false);
            pnlHoTenInput.PerformLayout();
            pnlMaNCCInput.ResumeLayout(false);
            pnlMaNCCInput.PerformLayout();
        ...
        private TextBox _txtMaNCC;
        private Label lblHoTen;
        private TextBox _txtHoTen;
        private Label lblMatHang;
        private RoundedPanel pnlMatHangInput;
        private TextBox _txtMatHang;
        ...
        private RoundedPanel pnlMaNCCInput;
        ...
        private RoundedPanel _btnXemLichSu;
        private Label lblBtnXemLichSu;
        private RoundedPanel _btnTaoDonNhap;
        private Label lblBtnTaoDonNhap;
        private RoundedPanel pnlDanhSachNhanVien;
        private Label lb_DSNhaCungCap;
        private DataGridView _dgvNhanVien;
        private Label _lblTongNccValue;
        private Label _lblTongTienNhapValue;
        private Label _lblNgayGiaoGanNhatValue;
    }
}