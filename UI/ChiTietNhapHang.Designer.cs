namespace PBL3
{
    partial class ChiTietNhapHang
    {
        ...
        {
            _lblTenNccTitle = new Label();
            _lblTenNccValue = new Label();
            ...
            // _lblTenNccTitle
            // 
            _lblTenNccTitle.AutoSize = true;
            _lblTenNccTitle.Location = new Point(12, 18);
            _lblTenNccTitle.Name = "_lblTenNccTitle";
            _lblTenNccTitle.Size = new Size(103, 20);
            _lblTenNccTitle.TabIndex = 0;
            _lblTenNccTitle.Text = "Nhà cung cấp:";
            // 
            // _lblTenNccValue
            // 
            _lblTenNccValue.AutoSize = true;
            _lblTenNccValue.Font = new Font("Segoe UI", 9F, FontStyle.Bold);
            _lblTenNccValue.Location = new Point(114, 18);
            _lblTenNccValue.Name = "_lblTenNccValue";
            _lblTenNccValue.Size = new Size(15, 20);
            _lblTenNccValue.TabIndex = 1;
            _lblTenNccValue.Text = "-";
            // 
            // _lblNguoiNhapTitle
            // 
            ...
            _lblNguoiNhapValue.Click += _lblNguoiNhapValue_Click;
            // 
            // _lblNgayNhapTitle
            // 
            ...
            _cboNguyenLieu.Size = new Size(200, 28);
            ...
            _nudSoLuong.Location = new Point(406, 84);
            ...
            Controls.Add(_lblTenNccValue);
            Controls.Add(_lblTenNccTitle);
            MinimumSize = new Size(600, 520);
            Name = "ChiTietNhapHang";
            StartPosition = FormStartPosition.CenterScreen;
            Text = "ChiTietNhapHang";
        ...
        private Label _lblTenNccTitle;
        private Label _lblTenNccValue;
